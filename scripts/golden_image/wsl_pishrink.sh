...
echo "         The AstroMechOS_Imager injects"
echo "         init=/usr/lib/raspberrypi-sys-mod/init_resize.sh"
echo "         into cmdline.txt at cold-flash time. We don't want"
echo "         pishrink's /etc/rc.local hack on top of that."
