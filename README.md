...
![Step 0 — Splash](https://raw.githubusercontent.com/RickDnamps/AstromechOS_Screenshots/main/Screenshots_Imager/splash_light.png?v=5)
...
![Step 1 — Selection](https://raw.githubusercontent.com/RickDnamps/AstromechOS_Screenshots/main/Screenshots_Imager/step1_selection_light.png?v=5)
...
![Step 2 — Target Drives](https://raw.githubusercontent.com/RickDnamps/AstromechOS_Screenshots/main/Screenshots_Imager/step2_target_drives_light.png?v=5)
...
![Step 3 — Security Validation](https://raw.githubusercontent.com/RickDnamps/AstromechOS_Screenshots/main/Screenshots_Imager/step3_security_validation_light.png?v=5)

### Step 4 — Customize

Three quick groups: the **robot login** (username + password used to SSH into the robot), an optional **home Wi-Fi** (so the robot can reach the internet), and the **internal robot link** password used by the two Pis of the robot to find each other. All fields are pre-filled with safe defaults so a beginner can just hit `NEXT`; experienced operators can override any of them. Every field has live ✓/✗ validation and the `NEXT` button is hard-gated until the form is valid.

![Step 4 — Customize](https://raw.githubusercontent.com/RickDnamps/AstromechOS_Screenshots/main/Screenshots_Imager/step4_customize_light.png?v=5)
...
![Step 5 — Confirm & Flash](https://raw.githubusercontent.com/RickDnamps/AstromechOS_Screenshots/main/Screenshots_Imager/step5_confirm_flash_light.png?v=5)
...
![Step 6 — Complete](https://raw.githubusercontent.com/RickDnamps/AstromechOS_Screenshots/main/Screenshots_Imager/step6_complete_light.png?v=5)
